    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children active dropdown" id="noticeBoardMng">
                    <a href="/admin/noticeMng" class="dropdown-toggle active"> <i class="menu-icon fa fa-cogs"></i>공지사항 관리</a>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </nav>
