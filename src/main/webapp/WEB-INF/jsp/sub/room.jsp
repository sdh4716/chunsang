		...
		<div id="sh_container">
			...
			<script>
				$(document).ready(function() {
					...
					$("#gallery_thumb_sky li").click(function() {
						var large_img_src = $("#large_img_sky").attr("src");
						var src = $(this).data('large');
						if (large_img_src == src) {return false;}
						$('#large_img_sky').fadeOut(0);
						$("#large_img_sky").attr("src",src);
						$('#large_img_sky').fadeIn(300);
						$(".gallery_thumb_sky li").removeClass('on');
						$(this).addClass('on');
					});
					
					$("#gallery_thumb_cloud li").click(function() {
						var large_img_src = $("#large_img_cloud").attr("src");
						var src = $(this).data('large');
						if (large_img_src == src) {return false;}
						$('#large_img_cloud').fadeOut(0);
						$("#large_img_cloud").attr("src",src);
						$('#large_img_cloud').fadeIn(300);
						$(".gallery_thumb_cloud li").removeClass('on');
						$(this).addClass('on');
					});
				...
				function showRoom(room){
					...
					$("#snb_sky").removeClass();
					$("#snb_cloud").removeClass();
					
					$("#snb_" + room).addClass("snb_on");
					
					$(".content_sky").css("display","none");
					$(".content_cloud").css("display","none");
			...
			<div id="sh_container_wrapper">
				...
				<div id="sh_aside">
					<div id="sh_aside_wrapper">
						<ul id="sh_snb">
	                        <li id="snb_sky" class="snb_on"><a href="javascript:showRoom('sky')">하늘</a></li>
	                        <li id="snb_cloud" class=""><a href="javascript:showRoom('cloud')">구름</a></li>
						</ul>
						<!-- 소분류 끝 -->
					</div>
				</div>
				<!-- 콘텐츠영역 -->
				<div id="sh_content" class="content_sky">
				...
				<!-- 콘텐츠영역 -->
				<div id="sh_content" class="content_cloud" style="display:none;">
					
					<!-- 하늘 -->
					<article id="sh_bo_v">
						<div class="tit">
							<p>구름</p>
							<span>원룸형 구조로 된 보다 넓고 쾌적한 객실</span>
						</div>
						<ul class="v_room_info">
							<li>
								<p class="info_c">객실명</p>
								<p class="info_name">구름</p>
							</li>
							<li>
								<p class="info_c">스타일</p>
								<p class="info_name">원룸형 구조</p>
							</li>
							<li>
								<p class="info_c">크기</p>
								<p class="info_name">12 평</p>
							</li>
							<li>
								<p class="info_c">인원(기준/최대)</p>
			...
			<div id="sh_container_wrapper" class="container_cloud">
